...
OUT = HERE / "contrast"; OUT.mkdir(exist_ok=True)
...
TEMPLATE = (
    "a tiny pure snow-white smooth-coat chihuahua standing on a wooden living room floor, "
    "{powder} caked and clinging in uneven clumps all over his coat, thick {powder} "
    "settled on his back, on his shoulders and around his neck, the powder clearly "
    "sitting on top of the white fur, blue collar with a plain silver tag, "
    "photorealistic close-up, warm afternoon window light, bright modern living room"
)
...
def build(powder, tag):
    return {
        ...
        "10": {"class_type": "SaveImage",
               "inputs": {"images": ["9", 0], "filename_prefix": f"contrast/{tag}"}},
    }
