...
> ⚠️ **2026-09-02 晚，賢賢裁示：產線重做。** 先讀 `01-企劃\產線重做-需求書-2026-09-02.md`。
> 新產線適用該需求書，**本檔鐵律 2（全本機、Veo 已移除）與鐵律 3（角色聖經唯一真相）對新產線不適用**：
> 新產線是全新吉娃娃、乾淨起步、不讀舊 prompt／policy／角色聖經；生成器順序等賢賢在需求書打勾。
> 舊產線（Taco & Nova 那 18 支）的維護與帳本仍照本檔。
